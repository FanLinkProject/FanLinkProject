        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                    ...
                    .requestMatchers(GET, "/api/artist-posts/artist-only").permitAll()
                    .requestMatchers(GET, "/api/likes/counts").permitAll()
                    .requestMatchers(GET, "/api/comments/counts").permitAll()
